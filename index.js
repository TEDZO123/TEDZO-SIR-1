...
const asw1 = 'https://i.imgur.com/uHXmJGa.jpeg'
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`917736835721@s.whatsapp.net`]
...
const daftar1 = `❑ Hi ${pushname} 🚀 ${ucapanWaktu} \n\n❑ Before Using the Bot Verify First 🙂`
       const daftar2 = '```©TEDZO VERIFICATION 😎```'
       const daftar3 = [
          {
            buttonId: `verify`,
            buttonText: {
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "917736835721@s.whatsapp.net";
...
*Thank you for registering in the 𝙰SL𝚄 𝚂𝙴𝚁😎 Database*
...
*「 𝙰slu 𝚂𝙴𝚁 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'ᴀslᴜ', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered 𝙰Sl𝚄 𝚂𝙴𝚁*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =` ▢ 𝐇𝐢 ${pushname} \n ▢ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ▢ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ▢ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ▢ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ▢ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ▢ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `𝙰SL𝚄 𝚂𝙴𝚁`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
│
│  ❑ *ʙᴏᴛ ɢʀᴏᴜᴘ ʟɪɴᴋ*
│  https://chat.whatsapp.com/KzPohCK51Tt0Ok4Gt0N12T
│
│  ❑ *ᴏᴡɴᴇʀ* : 
...
case 'credit':
   ...
   dtod1 = '917736835721'
   dtod2 = '917736835721'
   dtod3 = 'https://wa.me/917736835721'
   dtod4 ='0'
   var yez = `
╭───➤ 𝐀𝐃𝐌𝐈𝐍
│✨ wa.me/${dtod.split('@')[0]}
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://www.instagram.com/a_s_l_a_m_._x')
break
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "╭─➤ *ᴀslᴜ sɪʀ*\n│       ❑  *sᴄʀɪᴘᴛ*\n│❖   ɢɪᴛʜᴜʙ:\n│❖   Check In YouTube👇👇\n│❖   ʏᴏᴜᴛᴜʙᴇ:\n│❖   https://chat.whatsapp.com/KzPohCK51Tt0Ok4Gt0N12T8\n╰────────────────❋ཻུ۪۪⸙\n\n⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘\n             ᴀslᴜ sɪʀ\n\n╭◪ *ᴄᴏᴅᴅᴇᴅ ʙʏ ᴀSLᴜ*\n╰─────────────────❋ཻུ۪۪⸙"
        },
        "index": 0
      }
    ]
...
buttons = [{buttonId: `quote`,buttonText:{displayText: `Thx Dah Pake`},type:1}]
              ...
              buttonsMessage = {footerText:'𝙰slu 𝚂𝙴𝚁', imageMessage: imageMsg,
              contentText:`ɴᴏᴛᴇ: ʜᴏʀɴʏ = ʙᴏɴᴋs`,buttons,headerType:4}
              prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              xeon.relayWAMessage(prep)
					break
